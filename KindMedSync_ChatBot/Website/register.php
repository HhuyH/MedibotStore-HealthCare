...
<head>
    ...
    <title>Đăng ký - MediBot Store</title>
                ...
                <div class="col-lg-7">
                    <div class="register-right">
                        <div class="register-header">
                            ...
                            <p>Tạo tài khoản mới để bắt đầu sử dụng MediBot Store</p>
                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Bằng việc sử dụng dịch vụ MediBot Store, bạn đồng ý tuân thủ các điều khoản này.</p>
                    ...
                    <h6>4. Trách nhiệm</h6>
                    <p>MediBot Store không chịu trách nhiệm cho bất kỳ thiệt hại nào phát sinh từ việc sử dụng dịch vụ.</p>
                </div>
